...
export default function Body() {
  ...
  return (
    <>
      ...
      <section
        id="About"
        className="flex flex-col justify-center items-center mx-auto max-w-screen-xl sm:h-[calc(100vh-60px)] py-10"
      >
      ...
      <section
        id="Skills"
        className="flex flex-col justify-center items-center font-sans mx-auto max-w-screen-xl sm:pt-20 pt-10 pb-10"
      >
      ...
      >
        <div className="px-4 sm:px-0">
          ...
          <div className="grid sm:grid-cols-3 gap-y-5 sm:gap-x-5 mt-14">
                ...
                <DialogHeader className="justify-between">
                  <div className="flex items-center gap-3">
                    <div className="-mt-px flex flex-col sm:gap-y-1">
                      ...
                      >
                        Aplikasi BK SMK Negeri 6 Bandung
                      </Typography>
                      <Typography
                        variant="small"
                        color="gray"
